            ...
            foreach ($items as $item_key => $item_value) {
                ...
                if( isset( $product_type) && $product_type === 'redq_rental' ){
                    ...
                    foreach ($order_item_details as $order_item_key => $order_item_value ) {
                        ...
                        if( $order_item_value->key !== 'pickup_hidden_datetime' && $order_item_value->key !== 'return_hidden_datetime' && $order_item_value->key !== 'return_hidden_days' && $order_item_value->key !== 'redq_google_cal_sync_id' ){
