        ...
        if ( 'display' == $current_section ) {
            ...
            $settings = apply_filters( 'woocommerce_labels_settings', array(
                ...
                array(
                    ...
                    'type' => 'text',
                    'desc' => __( 'This text will show as pricing title in fornt-end', 'redq-rental' ),
                ...
                array(
                    ...
                    'type' => 'text',
                    'desc' => __( 'This text will show as Pickup location placeholder in fornt-end', 'redq-rental' ),
                ...
                array(
                    ...
                    'type' => 'text',
                    'desc' => __( 'This text will show as Dropoff location title in fornt-end', 'redq-rental' ),
                ...
                array(
                    ...
                    'type' => 'text',
                    'desc' => __( 'This text will show as Dropoff location placeholder in fornt-end', 'redq-rental' ),
                ...
                array(
                    ...
                    'type' => 'text',
                    'desc' => __( 'This text will show as Pickup Date Placeholder in fornt-end', 'redq-rental' ),
                ...
                array(
                    ...
                    'type' => 'text',
                    'desc' => __( 'This text will show as Pickup Time Placeholder in fornt-end', 'redq-rental' ),
                ...
                array(
                    ...
                    'type' => 'text',
                    'desc' => __( 'This text will show as Dropoff Date title in fornt-end', 'redq-rental' ),
                ...
                array(
                    ...
                    'type' => 'text',
                    'desc' => __( 'This text will show as Drop-off Date Placeholder in fornt-end', 'redq-rental' ),
                ...
                array(
                    ...
                    'type' => 'text',
                    'desc' => __( 'This text will show as Drop-off Time Placeholder in fornt-end', 'redq-rental' ),
                ...
                array(
                    ...
                    'type' => 'text',
                    'desc' => __( 'This text will show as Categories title in fornt-end', 'redq-rental' ),
                ...
                array(
                    ...
                    'type' => 'text',
                    'desc' => __( 'This text will show as Deposit title in fornt-end', 'redq-rental' ),
                ...
                array(
                    ...
                    'type' => 'text',
                    'desc' => __( 'This text will show as Adults title in fornt-end', 'redq-rental' ),
                    'id'   => 'rnb_adults_title',
                ...
                array(
                    ...
                    'type' => 'text',
                    'desc' => __( 'This text will show as Adults Placeholder in fornt-end', 'redq-rental' ),
                ...
                array(
                    ...
                    'type' => 'text',
                    'desc' => __( 'This text will show as Childs title in fornt-end', 'redq-rental' ),
                    'id'   => 'rnb_childs_title',
                ...
                array(
                    ...
                    'type' => 'text',
                    'desc' => __( 'This text will show as Childs Placeholder in fornt-end', 'redq-rental' ),
                ...
                array(
                    ...
                    'type' => 'text',
                    'desc' => __( 'This text will show as discount text in fornt-end', 'redq-rental' ),
                ...
                array(
                    ...
                    'type' => 'text',
                    'desc' => __( 'This text will show as Instance Pay text in fornt-end', 'redq-rental' ),
                ...
                array(
                    ...
                    'type' => 'text',
                    'desc' => __( 'This text will show as Total Cost text in fornt-end', 'redq-rental' ),
                ...
                array(
                    'title' => __( 'Book Now Text', 'redq-rental' ),
                    'type' => 'text',
                    'desc' => __( 'This text will show as Book Now text in fornt-end', 'redq-rental' ),
                ...
                array(
                    'title' => __( 'Request For Quote Text', 'redq-rental' ),
                    'type' => 'text',
                    'desc' => __( 'This text will show as Request For Quote text in fornt-end', 'redq-rental' ),
                    'id'   => 'rnb_rfq_text',
            ...
            $settings = apply_filters( 'woocommerce_conditions_settings', array(
                ...
                array(
                    'title'    => __( 'Block Rental Dates', 'redq-rental' ),
                    'desc'     => __( 'If you set the value as yes then date or range of dates will be blocked after placing an order depending on no. of inventories. If you set the value as no then date will not be blocked after placing the order', 'redq-rental' ),
                    'id'       => 'rnb_block_rental_days',
                    'type'     => 'select',
