...
<div class="rental_inventory redq-remove-rows sort ui-state-default postbox" style="background: none; border: none;">
	...
	<p  class="form-field">
		<?php if(isset($rnb_cat_key) && $rnb_cat_key >= 0): ?>
			...
			?>
			<select multiple="multiple" class="inventory-resources"  style="width:350px" name="inventory_cat[<?php if(isset($rnb_cat_key)){ echo $rnb_cat_key; } ?>][]" data-placeholder="<?php esc_attr_e( 'Set Categories', 'redq-rental' ); ?>" title="<?php esc_attr_e( 'Categories', 'redq-rental' ) ?>" class="wc-enhanced-select">
