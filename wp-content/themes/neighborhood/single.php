...
<?php	
	...
	$logo = __( $options['logo_upload'] , 'neighborhood' );
	}
		...
		<?php } ?>
				...
				<section class="article-body-wrap">
					...
					<div class="author-info-wrap clearfix">
						...
						<div class="post-info">
							<div class="author-name" itemprop="author" itemscope itemtype="http://schema.org/Person"><span><?php _e("Posted by", 'neighborhood'); ?></span><a itemprop="url" href="<?php echo get_author_posts_url(get_the_author_meta( 'ID' )); ?>"><span itemprop="name"><?php the_author_meta('display_name'); ?></span></a></div>
					...
					<div class="tags-link-wrap clearfix">
						<?php if (has_tag()) { ?>
						<div class="tags-wrap"><?php _e("Tags:", 'neighborhood'); ?><span class="tags"><?php the_tags(''); ?></span></div>
						<?php } ?>
						<div class="comments-likes">
						<?php if (function_exists( 'lip_love_it_link' )) {
							echo lip_love_it_link(get_the_ID(), '<i class="fas fa-heart"></i>', '<i class="fas fa-heart"></i>', false);
						} ?>				
						<?php if ( comments_open() ) { ?>
							<div class="comments-wrapper"><i class="fas fa-comments"></i><span><?php comments_number('0', '1', '%'); ?></span></div>
						<?php } ?>
						</div>
					</div>
					...
					<div class="share-links clearfix">
						<div class="share-text"><?php _e("Share:", 'neighborhood'); ?></div>
						<ul>
						    <li><a href="http://www.facebook.com/sharer.php?u=<?php the_permalink(); ?>" target="_blank" class="product_share_facebook"><i class="fab fa-facebook"></i></a></li>
						    <li><a href="https://twitter.com/share?url=<?php the_permalink(); ?>" target="_blank" class="product_share_twitter"><i class="fab fa-twitter"></i></a></li>   
						    <li><a href="https://plus.google.com/share?url={URL}" onclick="javascript:window.open(this.href,
						      '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><i class="fab fa-google-plus"></i></a></li>
						    <li><a href="http://pinterest.com/pin/create/button/?url=<?php the_permalink(); ?>&media=<?php if(function_exists('the_post_thumbnail')) echo wp_get_attachment_url(get_post_thumbnail_id()); ?>&description=<?php echo get_the_title(); ?>"><i class="fab fa-pinterest"></i></a></li>
							<li><a href="mailto:?subject=<?php the_title(); ?>&body=<?php echo strip_tags(get_the_excerpt()); ?> <?php the_permalink(); ?>" class="product_share_email"><i class="fas fa-envelope"></i></a></li>
						    <li><a class="permalink item-link" href="<?php the_permalink(); ?>"><i class="fas fa-link"></i></a></li>
						</ul>						
					</div>
				...
				<?php
					...
					if( $related_posts_query->have_posts() ) {
						_e("<h4>Related Articles</h4>", 'neighborhood');
				...
				<div class="pagination-wrap blog-pagination clearfix">
					<div class="nav-previous"><?php next_post_link('%link', __('<i class="fas fa-angle-left"></i> <span class="nav-text">%title</span>', 'neighborhood'), FALSE); ?></div>
					<div class="nav-next"><?php previous_post_link('%link', __('<span class="nav-text">%title</span><i class="fas fa-angle-right"></i>', 'neighborhood'), FALSE); ?></div>
				</div>
