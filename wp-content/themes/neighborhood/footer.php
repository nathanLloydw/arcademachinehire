<?php
							...
							$copyright_text = __($options['footer_copyright_text'], 'neighborhood');
							$go_top_text = __($options['footer_gotop_text'], 'neighborhood');
			...
			<footer id="copyright" class="<?php echo $copyright_class; ?>">
				<div class="container">
					...
					<div class="beam-me-up three columns offset-by-one"><a href="#"><?php echo do_shortcode(stripslashes($go_top_text)); ?><i class="fas fa-arrow-up"></i></a></div>
				</div>
			<!--// CLOSE #copyright //-->
			</footer>
