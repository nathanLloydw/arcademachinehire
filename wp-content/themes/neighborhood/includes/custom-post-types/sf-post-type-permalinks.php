    ...
    if ( ! class_exists( 'sf_post_type_permalinks' ) ) :
        ...
        class sf_post_type_permalinks {
            ...
            public function settings_init() {
                ...
                add_settings_section( 'sf-portfolio-permalink', __( 'Portfolio permalink base', 'neighborhood' ), array(
                        $this,
                        'portfolio_settings'
                    ), 'permalink' );

                // Add portfolio settings
                add_settings_field( 'portfolio_category_slug', __( 'Portfolio category base', 'neighborhood' ), array(
                        $this,
                        'portfolio_category_slug_input'
                    ), 'permalink', 'optional' );

                // Add galleries section to the permalinks page
                add_settings_section( 'sf-galleries-permalink', __( 'Galleries permalink base', 'neighborhood' ), array(
                        $this,
                        'galleries_settings'
                    ), 'permalink' );

                // Add galleries settings
                add_settings_field( 'galleries_category_slug', __( 'Galleries category base', 'neighborhood' ), array(
                        $this,
                        'galleries_category_slug_input'
                    ), 'permalink', 'optional' );

                // Add team section to the permalinks page
                add_settings_section( 'sf-team-permalink', __( 'Team permalink base', 'neighborhood' ), array(
                        $this,
                        'team_settings'
                    ), 'permalink' );

                // Add team settings
                add_settings_field( 'team_category_slug', __( 'Team category base', 'neighborhood' ), array(
                        $this,
                        'team_category_slug_input'
                    ), 'permalink', 'optional' );

                // Add team section to the permalinks page
                add_settings_section( 'sf-directory-permalink', __( 'Directory permalink base', 'neighborhood' ), array(
                        $this,
                        'directory_settings'
                    ), 'permalink' );

                // Add team settings
                add_settings_field( 'directory_category_slug', __( 'Directory category base', 'neighborhood' ), array(
                        $this,
                        'directory_category_slug_input'
                    ), 'permalink', 'optional' );

                // Add team settings
                add_settings_field( 'directory_location_slug', __( 'Directory location base', 'neighborhood' ), array(
                        $this,
                        'directory_location_slug_input'
                    ), 'permalink', 'optional' );

                // Add faqs section to the permalinks page
                add_settings_section( 'sf-faqs-permalink', __( 'FAQs permalink base', 'neighborhood' ), array(
                        $this,
                        'faqs_settings'
                    ), 'permalink' );

                // Add team settings
                add_settings_field( 'faqs_category_slug', __( 'FAQ category base', 'neighborhood' ), array(
                        $this,
            ...
            public function portfolio_category_slug_input() {
                ...
                <input name="portfolio_category_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'portfolio-category', 'neighborhood' ) ?>"/>
            <?php
            }
            ...
            public function galleries_category_slug_input() {
                ...
                <input name="galleries_category_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'galleries-category', 'neighborhood' ) ?>"/>
            <?php
            }
            ...
            public function team_category_slug_input() {
                ...
                <input name="team_category_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'team-category', 'neighborhood' ) ?>"/>
            <?php
            }
            ...
            public function directory_category_slug_input() {
                ...
                <input name="directory_category_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'directory-category', 'neighborhood' ) ?>"/>
            <?php
            }
            ...
            public function directory_location_slug_input() {
                ...
                <input name="directory_location_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'directory-location', 'neighborhood' ) ?>"/>
            <?php
            }
            ...
            public function faqs_category_slug_input() {
                ...
                <input name="faqs_category_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'faqs-category', 'neighborhood' ) ?>"/>
            <?php
            }

            public function portfolio_settings() {
                echo wpautop( __( 'These settings control the permalinks used for portfolio items. These settings only apply when <strong>not using "default" permalinks above</strong>.', 'neighborhood' ) );
                ...
                // Get portfolio page
                global $sf_options;
                $portfolio_page = __( $sf_options['portfolio_page'], 'neighborhood' );
                $base_slug      = ( $portfolio_page > 0 && get_page( $portfolio_page ) ) ? get_page_uri( $portfolio_page ) : __( 'portfolio', 'neighborhood' );
                $portfolio_base = __( 'portfolio', 'neighborhood' );
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th><label><input name="portfolio_permalink" type="radio" value="<?php echo $structures[0]; ?>"
                                          class="sf_port_tog" <?php checked( $structures[0], $portfolio_permalink ); ?> /> <?php _e( 'Default', 'neighborhood' ); ?>
                            </label></th>
                    ...
                    <tr>
                        <th><label><input name="portfolio_permalink" type="radio" value="<?php echo $structures[1]; ?>"
                                          class="sf_port_tog" <?php checked( $structures[1], $portfolio_permalink ); ?> /> <?php _e( 'Portfolio', 'neighborhood' ); ?>
                            </label></th>
                    ...
                    <?php if ( $portfolio_page ) : ?>
                        <tr>
                            <th><label><input name="portfolio_permalink" type="radio"
                                              ...
                                              class="sf_port_tog" <?php checked( $structures[2], $portfolio_permalink ); ?> /> <?php _e( 'Portfolio base', 'neighborhood' ); ?>
                                </label></th>
                            <td><code><?php echo home_url(); ?>/<?php echo $base_slug; ?>/sample-portfolio-item/</code>
                            </td>
                        </tr>
                        <!--<tr>
							<th><label><input name="portfolio_permalink" type="radio" value="<?php echo $structures[3]; ?>" class="sftog" <?php checked( $structures[3], $portfolio_permalink ); ?> /> <?php _e( 'Portfolio base with category', 'neighborhood' ); ?></label></th>
                    ...
                    <tr>
                        <th><label><input name="portfolio_permalink" id="sf_portfolio_custom_selection" type="radio"
                                ...
                                <?php _e( 'Custom Base', 'neighborhood' ); ?></label></th>
                        <td>
                            <input name="portfolio_permalink_structure" id="sf_portfolio_permalink_structure"
                                ...
                                class="description"><?php _e( 'Enter a custom base to use. A base <strong>must</strong> be set or WordPress will use default instead.', 'neighborhood' ); ?></span>
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            public function galleries_settings() {
                echo wpautop( __( 'These settings control the permalinks used for galleries. These settings only apply when <strong>not using "default" permalinks above</strong>.', 'neighborhood' ) );
                ...
                $base_slug      = __( 'galleries', 'neighborhood' );
                $galleries_base = __( 'galleries', 'neighborhood' );
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th><label><input name="galleries_permalink" type="radio" value="<?php echo $structures[0]; ?>"
                                          class="sf_gal_tog" <?php checked( $structures[0], $galleries_permalink ); ?> /> <?php _e( 'Default', 'neighborhood' ); ?>
                            </label></th>
                    ...
                    <tr>
                        <th><label><input name="galleries_permalink" type="radio" value="<?php echo $structures[1]; ?>"
                                          class="sf_gal_tog" <?php checked( $structures[1], $galleries_permalink ); ?> /> <?php _e( 'Galleries', 'neighborhood' ); ?>
                            </label></th>
            ...
            public function team_settings() {
                echo wpautop( __( 'These settings control the permalinks used for team members. These settings only apply when <strong>not using "default" permalinks above</strong>.', 'neighborhood' ) );
                ...
                $base_slug = __( 'team', 'neighborhood' );
                $team_base = __( 'team', 'neighborhood' );
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th><label><input name="team_permalink" type="radio" value="<?php echo $structures[0]; ?>"
                                          class="sf_team_tog" <?php checked( $structures[0], $team_permalink ); ?> /> <?php _e( 'Default', 'neighborhood' ); ?>
                            </label></th>
                    ...
                    <tr>
                        <th><label><input name="team_permalink" type="radio" value="<?php echo $structures[1]; ?>"
                                          class="sf_team_tog" <?php checked( $structures[1], $team_permalink ); ?> /> <?php _e( 'Team', 'neighborhood' ); ?>
                            </label></th>
            ...
            public function directory_settings() {
                echo wpautop( __( 'These settings control the permalinks used for directory items. These settings only apply when <strong>not using "default" permalinks above</strong>.', 'neighborhood' ) );
                ...
                $base_slug      = __( 'directory', 'neighborhood' );
                $directory_base = __( 'directory', 'neighborhood' );
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th><label><input name="directory_permalink" type="radio" value="<?php echo $structures[0]; ?>"
                                          class="sf_directory_tog" <?php checked( $structures[0], $directory_permalink ); ?> /> <?php _e( 'Default', 'neighborhood' ); ?>
                            </label></th>
                    ...
                    <tr>
                        <th><label><input name="directory_permalink" type="radio" value="<?php echo $structures[1]; ?>"
                                          class="sf_directory_tog" <?php checked( $structures[1], $directory_permalink ); ?> /> <?php _e( 'Directory', 'neighborhood' ); ?>
                            </label></th>
            ...
            public function faqs_settings() {
                echo wpautop( __( 'These settings control the permalinks used for FAQs. These settings only apply when <strong>not using "default" permalinks above</strong>.', 'neighborhood' ) );
                ...
                // Set base slug & directory base
                $base_slug      = __( 'faqs', 'neighborhood' );
                $faqs_base = __( 'faqs', 'neighborhood' );
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th><label><input name="faqs_permalink" type="radio" value="<?php echo $structures[0]; ?>"
                                          class="sf_faqs_tog" <?php checked( $structures[0], $faqs_permalink ); ?> /> <?php _e( 'Default', 'neighborhood' ); ?>
                            </label></th>
                    ...
                    <tr>
                        <th><label><input name="faqs_permalink" type="radio" value="<?php echo $structures[1]; ?>"
                                          class="sf_faqs_tog" <?php checked( $structures[1], $faqs_permalink ); ?> /> <?php _e( 'FAQs', 'neighborhood' ); ?>
                            </label></th>
