...
function lip_settings_page()
{
	...
	<div class="wrap">
		<div id="upb-wrap" class="upb-help">
			<h2><?php _e('Love It Pro Settings', 'neighborhood'); ?></h2>
			<?php
			...
			<form method="post" action="options.php">
				...
				<table class="form-table">
					<tbody>
						<tr valign="top">
							<th scope="row">
								<?php _e('Show on Post Types', 'neighborhood'); ?>
							</th>
							<td>
								<fieldset>
									<legend class="screen-reader-text">
										<span><?php _e('Show on Post Types', 'neighborhood'); ?></span>
									</legend>
									<label for="lip_settings[post_types][]">
										...
										<?php } ?>
										<?php _e( 'Display Love It link at top or bottom of the post/page content?', 'neighborhood' ); ?>
									</label>
								</fieldset>
							</td>
						</tr>
						<tr valign="top">
							<th scope="row">
								<?php _e('Love It Links', 'neighborhood'); ?>
							</th>
							<td>
								<fieldset>
									<legend class="screen-reader-text">
										<span><?php _e('Love It Links', 'neighborhood'); ?></span>
									</legend>
						...
						<tr valign="top">
							<th scope="row">
								<?php _e('Position', 'neighborhood'); ?>
							</th>
							<td>
								<fieldset>
									<legend class="screen-reader-text">
										<span><?php _e('Position', 'neighborhood'); ?></span>
									</legend>
									<label for="lip_settings[post_position]">
										<?php $positions = array('top' => __('Top', 'neighborhood'), 'bottom' => __('Bottom', 'neighborhood')); ?>
							...
							<td>
								<fieldset>
									...
									<label for="lip_settings[love_it_text]">
										...
										<?php _e( 'Enter the text you\'d like to use for the "Love It" link', 'neighborhood' ); ?>
									</label>
								</fieldset>
							</td>
						</tr>
						<tr valign="top">
							<th scope="row">
								<?php _e('Already Loved Text', 'neighborhood'); ?>
							</th>
							<td>
								<fieldset>
									<legend class="screen-reader-text">
									...
									<label for="lip_settings[already_loved]">
										...
										<?php _e( 'Enter the text you\'d like to use for the "You have already loved this item" text', 'neighborhood' ); ?>
									</label>
								</fieldset>
							</td>
						</tr>
						<tr valign="top">
							<th scope="row">
								<?php _e('Custom CSS', 'neighborhood'); ?>
							</th>
							<td>
								<fieldset>
									<legend class="screen-reader-text">
										<span><?php _e('Custom CSS', 'neighborhood'); ?></span>
									</legend>
									<label for="lip_settings[custom_css]">
										...
										<?php _e( 'Enter custom CSS here to customize the appearance of this plugin. To assist you, a list of available class names are available in the Help tab in the top right.', 'neighborhood' ); ?>
									</label>
								</fieldset>
							</td>
						</tr>
				...
				<!-- save the options -->
				<p class="submit">
					<input type="submit" class="button-primary" value="<?php _e( 'Save Options', 'neighborhood' ); ?>" />
				</p>
...
function lip_settings_menu() {
	global $love_it_page;
	// add settings page
	$love_it_page = add_submenu_page('options-general.php', __('Love It Settings', 'neighborhood'), __('Love It Settings', 'neighborhood'),'manage_options', 'love-it-settings', 'lip_settings_page');
	...
	switch($screen->id) :
		...
		case $love_it_page :
			...
			$screen->add_help_tab(
				array(
					'id' => 'template_tags',
					'title' => __('Template Tags', 'neighborhood'),
