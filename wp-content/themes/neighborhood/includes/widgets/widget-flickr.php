    ...
    */
    ...
    class sf_flickr_widget extends WP_Widget {
        ...
        function form( $instance ) {
            ...
            <p>
                <label
                    for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title', 'neighborhood' ); ?>
                    :</label>
            ...
            <p>
                <label
                    for="<?php echo $this->get_field_id( 'flickr_id' ); ?>"><?php _e( 'Flickr ID', 'neighborhood' ); ?>
                    :</label>
            ...
            <p>
                <label
                    for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of Photos', 'neighborhood' ); ?>
                    :</label>
