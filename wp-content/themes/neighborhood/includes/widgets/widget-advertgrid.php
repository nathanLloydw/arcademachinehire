<?php
	...
	*/
	...
	?>
		...
		<p>
			<label><?php _e('Title', 'neighborhood');?>:</label>
			<input id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $instance['title']; ?>" class="widefat" type="text" />
		</p>
		<p>
			<label><?php _e('Image 1 URL', 'neighborhood');?>:</label>
		...
		<p>
			<label><?php _e('Image 1 Link', 'neighborhood');?>:</label>
		...
		<p>
			<label><?php _e('Image 2 URL', 'neighborhood');?>:</label>
		...
		<p>
			<label><?php _e('Image 2 Link', 'neighborhood');?>:</label>
		...
		<p>
			<label><?php _e('Image 3 URL', 'neighborhood');?>:</label>
		...
		<p>
			<label><?php _e('Image 3 Link', 'neighborhood');?>:</label>
		...
		<p>
			<label><?php _e('Image 4 URL', 'neighborhood');?>:</label>
		...
		<p>
			<label><?php _e('Image 4 Link', 'neighborhood');?>:</label>
		...
		<p>
			<label><?php _e('Image 5 URL', 'neighborhood');?>:</label>
		...
		<p>
			<label><?php _e('Image 5 Link', 'neighborhood');?>:</label>
		...
		<p>
			<label><?php _e('Image 6 URL', 'neighborhood');?>:</label>
		...
		<p>
			<label><?php _e('Image 6 Link', 'neighborhood');?>:</label>
		...
		<p>
			<label><?php _e('Image 7 URL', 'neighborhood');?>:</label>
		...
		<p>
			<label><?php _e('Image 7 Link', 'neighborhood');?>:</label>
		...
		<p>
			<label><?php _e('Image 8 URL', 'neighborhood');?>:</label>
		...
		<p>
			<label><?php _e('Image 8 Link', 'neighborhood');?>:</label>
