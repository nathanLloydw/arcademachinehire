			...
			<ul class="recent-posts-list">
				...
				<li>
					...
					<div class="recent-post-details">
						...
						<span><?php printf(__('By %1$s on %2$s', 'neighborhood'), $post_author, $post_date); ?></span>
						<div class="comments-likes">
							<?php if ( comments_open() ) { ?>
								<a href="<?php echo $post_permalink; ?>#comment-area"><i class="fas fa-comments"></i><span><?php echo $post_comments; ?></span></a>
							<?php }	?>
							<?php if (function_exists( 'lip_love_it_link' )) {
								echo lip_love_it_link(get_the_ID(), '<i class="fas fa-heart"></i>', '<i class="fas fa-heart"></i>');
							} ?>
						</div>
					</div>
				</li>
