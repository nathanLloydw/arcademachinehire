<?php	
	...
	function social_icons($atts, $content = null) {
		...
		if ($type == '') {
			...
			if ($vk) {
				$social_icons .= '<li class="vk"><a href="'.$vk.'" target="_blank"><i class="fab fa-vk"></i></a></li>'."\n";
			}
			if ($twitch) {
				$social_icons .= '<li class="twitch"><a href="'.$twitch.'" target="_blank"><i class="fab fa-twitch"></i></a></li>'."\n";
			}
			if ($snapchat) {
				$social_icons .= '<li class="snapchat"><a href="'.$snapchat.'" target="_blank"><i class="fab fa-snapchat"></i></a></li>'."\n";
			}
			if ($whatsapp) {
				$social_icons .= '<li class="whatsapp"><a href="'.$whatsapp.'" target="_blank"><i class="fab fa-whatsapp"></i></a></li>'."\n";
			}
			if ($rss) {
				$social_icons .= '<li class="rss"><a href="'.$rss.'" target="_blank"><i class="fas fa-rss"></i></a></li>'."\n";
			}
		...
		function sf_sitemap($params = array()) {  
		    ...
		    $sitemap = '<div class="sitemap-wrap clearfix">';
		        ...
		        $sitemap .= '<div class="sitemap-col">';
		            ...
		            $sitemap .= '<h3>'.__("Pages", 'neighborhood').'</h3>';
		        ...
		        $sitemap .= '<div class="sitemap-col">';
		        	...
		        	$sitemap .= '<h3>'.__("Posts", 'neighborhood').'</h3>';
		    	...
		    	$sitemap .= '<div class="sitemap-col">';
		        	...
		        	$sitemap .= '<h3>'.__("Categories", 'neighborhood').'</h3>';
		        	...
		        	$sitemap .= '<h3>'.__("Archives", 'neighborhood').'</h3>';
	...
	if ( ! function_exists( 'sf_share_links' ) ) {
	    function sf_share_links() {
			...
			$share_output .= '<span>'. __("Share", 'neighborhood') .'</span>';
			$share_output .= '<ul>';
			$share_output .= '<li><a href="mailto:?subject='.$title.'&body='.$desc.' '.$url.'" class="share_email"><i class="fas fa-envelope"></i></a></li>';
			$share_output .= '<li><a href="http://www.facebook.com/sharer.php?u='.$url.'" onclick="'.$window_code.'" class="share_facebook"><i class="fab fa-facebook"></i></a></li>';
			$share_output .= '<li><a href="https://twitter.com/share?url='.$url.'" onclick="'.$window_code.'"class="share_twitter"><i class="fab fa-twitter"></i></a></li>';
		 	$share_output .= '<li><a href="https://plus.google.com/share?url='.$url.'" onclick="'.$window_code.'"><i class="fab fa-google-plus"></i></a></li>';
			$share_output .= '<li><a href="//pinterest.com/pin/create/button/?url='.$url.'&media='.$img_url.'&description='.$title.'" onclick="'.$window_code.'" class="share_pinterest"><i class="fab fa-pinterest"></i></a></li>';
			$share_output .= '</ul>';
			$share_output .= '</div>';
