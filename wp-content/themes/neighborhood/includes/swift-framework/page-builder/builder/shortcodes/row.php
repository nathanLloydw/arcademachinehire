    ...
    */
    ...
    class SwiftPageBuilderShortcode_spb_row extends SwiftPageBuilderShortcode {
        ...
        public function contentAdmin( $atts, $content = null ) {
            ...
            $output .= '<div class="controls sidebar-name"><span class="asset-name">' . __( "Row", 'neighborhood' ) . '</span><div class="controls_right"><a class="column_edit" href="#" title="Edit"></a> <a class="column_clone" href="#" title="Clone"></a> <a class="column_delete" href="#" title="Delete"></a></div></div>';
    ...
    $params = array(
        array(
            ...
            "heading"    => __( "Row Type Options", 'neighborhood' ),
        ),
        array(
            "type"        => "dropdown",
            "heading"     => __( "Wrap type", 'neighborhood' ),
            "param_name"  => "wrap_type",
            "value"       => array(
                __( 'Standard Width Content', 'neighborhood' ) => "content-width",
                __( 'Full Width Content', 'neighborhood' )     => "full-width"
            ),
            "description" => __( "Select if you want to row to wrap the content to the grid, or if you want the content to be edge to edge.", 'neighborhood' )
        ),
        array(
            "type"        => "dropdown",
            "heading"     => __( "Row Background Type", 'neighborhood' ),
            "param_name"  => "row_bg_type",
            "value"       => array(
                __( "Color", 'neighborhood' ) => "color",
        ...
        array(
            "type"        => "colorpicker",
            "heading"     => __( "Background color", 'neighborhood' ),
            "param_name"  => "row_bg_color",
            "value"       => "",
            "description" => __( "Select a background colour for the row here.", 'neighborhood' )
        ),
        array(
            "type"        => "dropdown",
            "heading"     => __( "Color Row Height", 'neighborhood' ),
            ...
            "description" => __( "If you are using this as a coloured row asset, then please choose whether you'd like asset to sized based on the content height or the window height.", 'neighborhood' )
        ),
        array(
            "type"       => "section",
            "param_name" => "section_bg_image_options",
            "heading"    => __( "Row Background Image Options", 'neighborhood' ),
            "required"       => array("row_bg_type", "=", "image"),
        ),
        array(
            "type"       => "section",
            "param_name" => "section_bg_video_options",
            "heading"    => __( "Row Background Video Options", 'neighborhood' ),
        ...
        array(
            "type"        => "dropdown",
            "heading"     => __( "Background Image Type", 'neighborhood' ),
            "param_name"  => "bg_type",
            "value"       => array(
        ...
        array(
            "type"        => "dropdown",
            "heading"     => __( "Background Image Movement", 'neighborhood' ),
        ...
        array(
            ...
            "required"       => array("row_bg_type", "=", "video"),
            "description" => __( "If you are using this as a video parallax asset, then please choose whether you'd like asset to sized based on the content height or the video height.", 'neighborhood' )
        ),
        array(
            "type"       => "section",
            "param_name" => "section_display_options",
            "heading"    => __( "Row Display Options", 'neighborhood' ),
        ),
    );
 
    $params[] = array(
        "type"        => "dropdown",
        "heading"     => __( "Row Overlay style", 'neighborhood' ),
        ...
        "description" => __( "If you would like an overlay to appear on top of the image/video, then you can select it here.", 'neighborhood' )
    );
    $params[] = array(
        "type"        => "uislider",
        "heading"     => __( "Row Overlay Opacity", 'neighborhood' ),
        "param_name"  => "row_overlay_opacity",
        "value"       => "0",
        "step"        => "5",
        "min"         => "0",
        "max"         => "100",
        "description" => __( "Adjust the overlay capacity if using an image or video option. This only has effect for the color overlay style option, and shows an overlay over the image/video at the desired opacity. Percentage.", 'neighborhood' )
    );
    $params[] = array(
        "type"        => "uislider",
        "heading"     => __( "Padding - Vertical", 'neighborhood' ),
        "param_name"  => "row_padding_vertical",
        "value"       => "0",
        "description" => __( "Adjust the vertical padding for the row. (px)", 'neighborhood' )
    );
    ...
    $params[] = array(
        ...
        "step"        => "1",
        "max"         => "20",
        "description" => __( "Adjust the horizontal padding for the row. (%)", 'neighborhood' )
    );
 
    $params[] = array(
        "type"        => "uislider",
        "heading"     => __( "Margin - Vertical", 'neighborhood' ),
        "param_name"  => "row_margin_vertical",
        "value"       => "0",
        "description" => __( "Adjust the margin above and below the row. (px)", 'neighborhood' )
    );
    $params[] = array(
        "type"        => "buttonset",
        "heading"     => __( "Remove Element Spacing", 'neighborhood' ),
        "param_name"  => "remove_element_spacing",
        "value"       => array(
            __( 'No', 'neighborhood' )  => "no",
            __( 'Yes', 'neighborhood' ) => "yes"
        ),
        "description" => __( "Enable this option if you wish to remove all spacing from the elements within the row.", 'neighborhood' )
    );
    $params[] = array(
        "type"        => "buttonset",
        "heading"     => __( "Vertically Center Elements Within", 'neighborhood' ),
        "param_name"  => "vertical_center",
        "value"       => array(
            __( 'No', 'neighborhood' )  => "false",
            __( 'Yes', 'neighborhood' ) => "true"
        ),
        "description" => __( "Enable this option if you wish to center the elements within the row.", 'neighborhood' )
    );
    $params[] = array(
        "type"        => "dropdown",
        "heading"     => __( "Inner Column Height", 'neighborhood' ),
        "param_name"  => "inner_column_height",
        "value"       => array(
            __( 'Natural', 'neighborhood' )  => "col-natural",
            __( 'Window Height', 'neighborhood' ) => "col-window-height"
        ),
        "description" => __( "If you have the Window Height option selected for the row, and would like inner column assets to be 100% height, then please select the Window Height option here.", 'neighborhood' )
    );
    $params[] = array(
        "type"       => "section",
        "param_name" => "section_reveal_options",
        "heading"    => __( "Row Content Expand Options", 'neighborhood' ),
    );
    $params[] = array(
        "type"        => "buttonset",
        "heading"     => __( "Expanding Row", 'neighborhood' ),
        "param_name"  => "row_expanding",
        "value"       => array(
            __( "No", 'neighborhood' )             => "no",
            __( "Yes", 'neighborhood' )             => "yes",
        ),
        "description" => __( "If you would like the content to be hidden on load, and have a text link to expand the content, then select Yes.", 'neighborhood' )
    );
    $params[] = array(
        "type"        => "textfield",
        "heading"     => __( "Expanding Link Text (Content Closed)", 'neighborhood' ),
        "param_name"  => "row_expading_text_closed",
        "value"       => "",
        "description" => __( "This is the text that is shown when the expanding row is closed.", 'neighborhood' )
    );
    $params[] = array(
        "type"        => "textfield",
        "heading"     => __( "Expanding Link Text (Content Open)", 'neighborhood' ),
        "param_name"  => "row_expading_text_open",
        "value"       => "",
        "description" => __( "This is the text that is shown when the expanding row is open.", 'neighborhood' )
    );
//    $params[] = array(
//        "type"       => "section",
//        "param_name" => "row_animation_options",
//        "heading"    => __( "Animation Options", 'neighborhood' ),
//    );
//    $params[] = array(
//        "type"        => "dropdown",
//        "heading"     => __( "Intro Animation", 'neighborhood' ),
//        "param_name"  => "row_animation",
//        "value"       => spb_animations_list(),
//        "description" => __( "Select an intro animation for the row which will show it when it appears within the viewport.", 'neighborhood' )
//    );
//    $params[] = array(
//        "type"        => "textfield",
//        "heading"     => __( "Animation Delay", 'neighborhood' ),
//        "param_name"  => "row_animation_delay",
//        "value"       => "0",
//        "description" => __( "If you wish to add a delay to the animation, then you can set it here (ms).", 'neighborhood' )
//    );
    $params[] = array(
        "type"       => "section",
        "param_name" => "section_misc_options",
        "heading"    => __( "Row Misc Options", 'neighborhood' ),
    );
//    $params[] = array(
//        "type"        => "dropdown",
//        "heading"     => __( "Responsive Visiblity", 'neighborhood' ),
//        "param_name"  => "row_responsive_vis",
//        "holder"      => 'indicator',
//        "value"       => spb_responsive_vis_list(),
//        "description" => __( "Set the responsive visiblity for the row, if you would only like it to display on certain display sizes.", 'neighborhood' )
//    );
//    $params[] = array(
//        "type"        => "textfield",
//        "heading"     => __( "Row ID", 'neighborhood' ),
//        "param_name"  => "row_id",
//        "value"       => "",
//        "description" => __( "If you wish to add an ID to the row, then add it here. You can then use the id to deep link to this section of the page. This is also used for one page navigation. NOTE: Make sure this is unique to the page!!", 'neighborhood' )
//    );
//    $params[] = array(
//        "type"        => "textfield",
//        "heading"     => __( "Row Section Name", 'neighborhood' ),
//        "param_name"  => "row_name",
//        "value"       => "",
//        "description" => __( "This is used for the one page navigation, to identify the row. If this is left blank, then the row will be left off of the one page navigation.", 'neighborhood' )
//    );
    $params[] = array(
        "type"        => "textfield",
