...
class SwiftPageBuilderShortcode_posts_carousel extends SwiftPageBuilderShortcode {
    ...
    protected function content($atts, $content = null) {
			...
			while ( $blog_items->have_posts() ) : $blog_items->the_post();
				...
				if ($show_details == "yes") {
					$items .= '<div class="post-details">'. sprintf(__('By %1$s on %2$s', 'neighborhood'), $post_author, $post_date) .'</div>';
				}
...
SPBMap::map( 'posts_carousel', array(
    "name"		=> __("Posts Carousel", 'neighborhood'),
    "base"		=> "posts_carousel",
    ...
    "params"	=> array(
        ...
        array(
            ...
            "value" => "12",
            "description" => __("The number of blog items to show in the carousel.", 'neighborhood')
        ),
        array(
            "type" => "select-multiple",
            "heading" => __("Posts category", 'neighborhood'),
            "param_name" => "category",
