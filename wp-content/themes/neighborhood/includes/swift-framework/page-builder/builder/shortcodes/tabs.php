	...
	*/
	...
	class SwiftPageBuilderShortcode_spb_tab extends SwiftPageBuilderShortcode {
	    ...
	    public function contentAdmin($atts, $content) {
	        $title = '';
	        $defaults = array( 'title' => __('Tab', 'neighborhood') );
	...
	SPBMap::map( 'spb_tabs', array(
		...
		<div class="tab_controls">
			<button class="add_tab">'.__("Add New Tab", 'neighborhood').'</button>
	</div>
	    ...
	    'default_content' => '
		<ul>
			<li><a href="#tab-1"><span>'.__('Tab 1', 'neighborhood').'</span></a><a class="edit_tab"></a><a class="delete_tab"></a></li>
			<li><a href="#tab-2"><span>'.__('Tab 2', 'neighborhood').'</span></a><a class="edit_tab"></a><a class="delete_tab"></a></li>
		</ul>
