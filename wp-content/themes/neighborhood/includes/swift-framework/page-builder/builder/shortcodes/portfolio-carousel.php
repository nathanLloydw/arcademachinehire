			...
			while ( $portfolio_items->have_posts() ) : $portfolio_items->the_post();
				...
				if ($thumb_type == "video") {
					...
					if($image) {
						...
						$items .= '<i class="fas fa-'.$item_icon.'"></i>';
						$items .= '</div></div>';
				...
				$items .= '<h4 class="portfolio-item-title"><a href="'.$permalink.'"><span>'. $item_title .'</span><i class="fas fa-angle-right"></i></a></h4>';
				$items .= '</div>';
...
SPBMap::map( 'portfolio_carousel', array(
    "name"		=> __("Portfolio Carousel", 'neighborhood'),
    ...
    "params"	=> array(
        ...
        array(
            ...
            "value" => "12",
            "description" => __("The number of portfolio items to show in the carousel.", 'neighborhood')
        ),
        array(
