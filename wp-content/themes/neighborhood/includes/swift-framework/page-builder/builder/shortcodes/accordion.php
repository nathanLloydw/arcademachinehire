	...
	*/
	...
	class SwiftPageBuilderShortcode_spb_accordion_tab extends SwiftPageBuilderShortcode {
	    ...
	    public function contentAdmin( $atts, $content = null ) {
	        $title = '';
	        $defaults = array( 'title' => __('Section', 'neighborhood') );
	        ...
	        foreach ( $this->settings['params'] as $param ) {
	            if ( $param['param_name'] != 'content' ) {
	                if ( is_string($param['value']) ) {
	                    $shortcode_attributes[$param['param_name']] = __($param['value'], 'neighborhood');
	                } else {
	...
	SPBMap::map( 'spb_accordion', array(
	    "name"		=> __("Accordion", 'neighborhood'),
	    "base"		=> "spb_accordion",
	    "controls"	=> "full",
	    "class"		=> "spb_accordion",
	    ...
	    "params"	=> array(
	        array(
	            ...
	            "value" => "",
	            "description" => __("What text use as widget title. Leave blank if no title is needed.", 'neighborhood')
	        ),
	        array(
	            "type" => "textfield",
	            "heading" => __("Active Section", 'neighborhood'),
	            "param_name" => "active_section",
	            "value" => "",
	            "description" => __("You can set the section that is active here by entering the number of the section here. NOTE: The first section would be 0, second would be 1, and so on. Leave blank for all sections to be closed by default.", 'neighborhood')
	        ),
	        array(
	            "type" => "textfield",
		...
		<div class="tab_controls">
			<button class="add_tab">'.__("Add section", 'neighborhood').'</button>
		</div>
	    ...
	    'default_content' => '
		<div class="group">
			<h3><a class="title-text" href="#">'.__('Section 1', 'neighborhood').'</a><a class="delete_tab"></a><a class="edit_tab"></a></h3>
			<div>
				<div class="row-fluid spb_column_container spb_sortable_container not-column-inherit">
					[spb_text_block width="1/1"] '.__('This is a text block. Click the edit button to change this text.', 'neighborhood').' [/spb_text_block]
				</div>
			</div>
		</div>
		<div class="group">
			<h3><a class="title-text" href="#">'.__('Section 2', 'neighborhood').'</a><a class="delete_tab"></a><a class="edit_tab"></a></h3>
			<div>
				<div class="row-fluid spb_column_container spb_sortable_container not-column-inherit">
					[spb_text_block width="1/1"] '.__('This is a text block. Click the edit button to change this text.', 'neighborhood').' [/spb_text_block]
				</div>
