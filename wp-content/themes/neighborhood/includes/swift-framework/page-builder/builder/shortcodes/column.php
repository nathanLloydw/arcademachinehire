    ...
    SPBMap::map( 'spb_column', array(
        ...
        "params"          => array(
            array(
                ...
                "heading"    => __( "Column Background Options", 'neighborhood' ),
            ),
            array(
                "type"        => "colorpicker",
            ...
            array(
                ...
                "heading"    => __( "Column Background Image Options", 'neighborhood' ),
            ),
            array(
                "type"        => "attach_image",
            ...
            array(
                ...
                "heading"    => __( "Column Display Options", 'neighborhood' ),
            ),
            array(
                "type"        => "uislider",
                "heading"     => __( "Padding", 'neighborhood' ),
                "param_name"  => "col_padding",
                "value"       => "0",
                "min"         => "0",
                "step"        => "1",
                "max"         => "20",
                "description" => __( "Adjust the padding for the column. (%)", 'neighborhood' )
            ),
//            array(
//                "type"       => "section",
...
//                "description" => __( "Select an intro animation for the column which will show it when it appears within the viewport.", 'neighborhood' )
//            ),
//            array(
//                "type"        => "textfield",
...
//            ),
            array(
                ...
                "heading"    => __( "Column Misc Options", 'neighborhood' ),
            ),
//            array(
//                "type"        => "dropdown",
