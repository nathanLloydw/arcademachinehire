...
SPBMap::map( 'googlechart', array(
    "name"		=> __("Google Chart", 'neighborhood'),
    "base"		=> "googlechart",
    ...
    "params"	=> array(
	    ...
	    array(
	        "type" => "textfield",
	        "heading" => __("Chart title", 'neighborhood'),
	        "param_name" => "chart_title",
	        "value" => "",
	        "description" => __("Chart title text. Leave it empty if not needed.", 'neighborhood')
	    ),
	    array(
	        "type" => "dropdown",
	        "heading" => __("Chart type", 'neighborhood'),
	        "param_name" => "type",
	        "value" => array(__('Line', 'neighborhood') => "line", __('Pie', 'neighborhood') => "pie", __('Pie 2D', 'neighborhood') => "pie2d", __('XY Line', 'neighborhood') => "xyline", __('Scatter', 'neighborhood') => "scatter"),
	        "description" => __("Choose the type of chart you'd like to display.", 'neighborhood')
	    ),
	    array(
	        "type" => "textfield",
	        "heading" => __("Chart labels", 'neighborhood'),
	        "param_name" => "labels",
	        "value" => "",
	        "description" => __("Enter the chart labels here, e.g. First+Label|Second+Label|Third+Label|Fourth+Label", 'neighborhood')
	    ),
	    array(
	        "type" => "textfield",
	        "heading" => __("Chart data", 'neighborhood'),
	        "param_name" => "data",
	        "value" => "",
	        "description" => __("Enter the chart data here, e.g. 41.12,32.35,21.52,5.01", 'neighborhood')
	    ),
	    array(
	        "type" => "textfield",
	        "heading" => __("Chart data colours", 'neighborhood'),
	        "param_name" => "data_colours",
	        "value" => "",
	        "description" => __("Enter the chart data colours here (hex without the #), e.g. D73030,329E4A,415FB4,DFD32F", 'neighborhood')
	    ),
	    array(
	        "type" => "textfield",
	        "heading" => __("Advanced chart data", 'neighborhood'),
	        "param_name" => "advanced_data",
	        "value" => "",
	        "description" => __("Enter the any advanced chart data here", 'neighborhood')
	    ),
        array(
            "type" => "textfield",
