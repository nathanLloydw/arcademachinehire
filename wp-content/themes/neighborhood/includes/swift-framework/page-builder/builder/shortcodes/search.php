...
SPBMap::map( 'search_widget', array(
    ...
    "params"	=> array(
    	array(
    	    "type" => "textfield",
    	    "heading" => __("Input placeholder text", 'neighborhood'),
    	    "param_name" => "search_input_text",
    	    "value" => "Search",
    	    "description" => __("Enter the text that appearas as default in the search input.", 'neighborhood')
    	),
    	array(
    	    "type" => "dropdown",
    	...
    	array(
    	    "type" => "dropdown",
    	    "heading" => __("Border above widget", 'neighborhood'),
    	    "param_name" => "pb_border_top",
    	    "value" => array(__('No', 'neighborhood') => "no", __('Yes', 'neighborhood') => "yes"),
    	    "description" => __("Add a top border to the widget.", 'neighborhood')
    	),
    	array(
    	    "type" => "textfield",
