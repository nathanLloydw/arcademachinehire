...
SPBMap::map( 'spb_revslider', array(
    "name"		=> __("Revolution Slider", 'neighborhood'),
    "base"		=> "spb_revslider",
    "class"		=> "spb_revslider",
    ...
    "params"	=> array(
        array(
            "type" => "textfield",
            "heading" => __("Revolution Slider Alias", 'neighborhood'),
            "param_name" => "revslider_shortcode",
            "value" => "",
            "description" => __("Enter the Revolution Slider alias here for the one that you wish to show. This can be found within the Revolution Slider Admin Panel.", 'neighborhood')
        ),
        array(
            "type" => "textfield",
