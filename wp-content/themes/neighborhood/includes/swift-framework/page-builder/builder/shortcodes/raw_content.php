	...
	SPBMap::map( 'spb_raw_js', array(
		...
		"params"	=> array(
			array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => __("Raw js", 'neighborhood'),
				"param_name" => "content",
				"value" => __(base64_encode("alert('Enter your js here!');"), 'neighborhood'),
				"description" => __("Enter your Js.", 'neighborhood')
			),
		)
	) );