	...
	class SwiftPageBuilder extends SFPageBuilderAbstract {
	    ...
	    public function elementBackendHtmlJavascript_callback() {
	        ...
	        if ( $data_element == 'spb_column' && $this->post( 'data_width' )!==null ) {
	            ...
	            echo $output;
				         ...
				         $output = do_shortcode( '[spb_text_block]'.__("<p>This is a text block. Click the edit button to change this text.</p>", 'neighborhood').'[/spb_text_block]' );
	            	echo $output;
	        }
			 else {
	    ...
	    public function deleteTemplateJavascript_callback() {
            ...
            if ( $element_name == 'Tabs' ) {
                $singular_name = __( "Tab", 'neighborhood' );
            } else {
                $singular_name = __( "Section", 'neighborhood' );
            }
	     ...
	     public function loadSFTemplateJavascript_callback() {
			...
			if ($template_id == "sf-home") {
				...
				[chart percentage="80" size="170" barcolour="#1bbeb4" trackcolour="#baebe8" content="fas fa-mobile-phone" align="center"]
				...
				<p style="text-align: center;"><a class="read-more" href="/features#responsive">Find out more <i class="fas fa-chevron-right">&gt;</i></a></p>
				[/spb_text_block] [spb_text_block pb_margin_bottom="no" pb_border_bottom="no" width="1/4"]
				
				[chart percentage="66" size="170" barcolour="#1bbeb4" trackcolour="#baebe8" content="fas fa-pencil" align="center"]
				...
				<p style="text-align: center;"><a class="read-more" href="/features#pagebuilder">Find out more <i class="fas fa-chevron-right">&gt;</i></a></p>
				[/spb_text_block] [spb_text_block pb_margin_bottom="no" pb_border_bottom="no" width="1/4"]
				
				[chart percentage="55" size="170" barcolour="#1bbeb4" trackcolour="#baebe8" content="fas fa-font" align="center"]
				...
				<p style="text-align: center;"><a class="read-more" href="/features#fonts">Find out more <i class="fas fa-chevron-right">&gt;</i></a></p>
				[/spb_text_block] [spb_text_block pb_margin_bottom="no" pb_border_bottom="no" width="1/4" el_position="last"]
				
				[chart percentage="88" size="170" barcolour="#1bbeb4" trackcolour="#baebe8" content="fas fa-eye-open" align="center"]
				...
				<p style="text-align: center;"><a class="read-more" href="/features#sliders">Find out more <i class="fas fa-chevron-right">&gt;</i></a></p>
				...
				<h2>Neighborhood: A clean, responsive &amp; retina-ready multipurpose eCommerce WordPress theme.</h2>
				[/impact_text] [blank_spacer height="60px" width="1/1" el_position="first last"] [spb_text_block title="Incredibly Responsive" icon="fas fa-mobile-phone" pb_margin_bottom="no" pb_border_bottom="no" width="1/4" el_position="first"]
				...
				<a class="read-more" href="/features#responsive">Find out more <i class="fas fa-chevron-right">&gt;</i></a>
				
				[/spb_text_block] [spb_text_block title="Swift Page Builder" icon="fas fa-pencil" pb_margin_bottom="no" pb_border_bottom="no" width="1/4"]
				...
				<a class="read-more" href="/features#pagebuilder">Find out more <i class="fas fa-chevron-right">&gt;</i></a>
				
				[/spb_text_block] [spb_text_block title="Superior Typography" icon="fas fa-font" pb_margin_bottom="no" pb_border_bottom="no" width="1/4"]
				...
				<a class="read-more" href="/features#fonts">Find out more <i class="fas fa-chevron-right">&gt;</i></a>
				
				[/spb_text_block] [spb_text_block title="Stunning Sliders" icon="fas fa-eye-open" pb_margin_bottom="no" pb_border_bottom="no" width="1/4" el_position="last"]
				...
				<a class="read-more" href="/features#sliders">Find out more <i class="fas fa-chevron-right">&gt;</i></a>
				...
				[/spb_text_block] [blank_spacer height="36px" width="1/1" el_position="first last"] [portfolio_carousel title="Recent Projects" item_count="5" category="all" alt_background="alt-one" el_class="mt0 mb0 bb0" width="1/1" el_position="first last"] [testimonial_slider title="Testimonials" text_size="large" item_count="6" order="date" category="all" animation="slide" autoplay="no" alt_background="alt-four" el_class="mt0 bt0" width="1/1" el_position="first last"] [blank_spacer height="20px" width="1/1" el_position="first last"] [recent_posts title="Latest From Our Blog" item_count="4" category="all" excerpt_length="16" width="1/1" el_position="first last"] [blank_spacer height="31px" width="1/1" el_position="first last"]';	
		 		...
		 		[chart percentage="85" size="170" barcolour="#1bbeb4" trackcolour="#baebe8" content="fas fa-eye-open" align="center"]
		 		...
		 		[chart percentage="80" size="170" barcolour="#1bbeb4" trackcolour="#baebe8" content="fas fa-tasks" align="center"]
		 		...
		 		[chart percentage="60" size="170" barcolour="#1bbeb4" trackcolour="#baebe8" content="fas fa-bullhorn" align="center"]
		 		<h3 style="text-align: center;">Marketing: <span style="color: #1bbeb4;">60%</span></h3>
		 		<p style="text-align: center;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse viverra mauris eget tortor imperdiet vehicula. Proin egestas diam ac mauris molestie hendrerit. Quisque nec nisi tortor. Etiam at mauris sit amet magna suscipit hend merit non sed ligula. Vivamus purus odio, mollis.</p>
		 		 [chart percentage="50" size="170" barcolour="#1bbeb4" trackcolour="#baebe8" content="fas fa-truck" align="center"]
		 		...
		 		[chart percentage="75" size="170" barcolour="#1bbeb4" trackcolour="#baebe8" content="fas fa-sitemap" align="center"]
		 		<h3 style="text-align: center;">User Interface Design: <span style="color: #1bbeb4;">75%</span></h3>
		 		<p style="text-align: center;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse viverra mauris eget tortor imperdiet vehicula. Proin egestas diam ac mauris molestie hendrerit. Quisque nec nisi tortor. Etiam at mauris sit amet magna suscipit hend merit non sed ligula. Vivamus purus odio, mollis.</p>
		 		 [chart percentage="95" size="170" barcolour="#1bbeb4" trackcolour="#baebe8" content="fas fa-camera" align="center"]
	        	...
	        	[chart percentage="100" size="170" barcolour="#1bbeb4" trackcolour="#baebe8" content="fas fa-mobile-phone" align="center"]
	        	<h3 style="text-align: center;">Incredibly Responsive</h3>
	        	...
	        	<p style="text-align: center;"><a class="read-more" href="#">Find out more <i class="fas fa-chevron-right">&gt;</i></a></p>
	        	[/spb_text_block] [spb_text_block pb_margin_bottom="no" pb_border_bottom="no" width="1/4"]
	        	
	        	[chart percentage="100" size="170" barcolour="#1bbeb4" trackcolour="#baebe8" content="fas fa-pencil" align="center"]
	        	<h3 style="text-align: center;">Swift Page Builder</h3>
	        	...
	        	[chart percentage="100" size="170" barcolour="#1bbeb4" trackcolour="#baebe8" content="fas fa-font" align="center"]
	        	<h3 style="text-align: center;">Superior Typography</h3>
	        	<p style="text-align: center;">Neighborhood includes pro Font Deck support. Or you can choose from 600+ Google Web fonts &amp; control the colour, size &amp; line height.</p>
	        	<p style="text-align: center;"><a class="read-more" href="#">Find out more <i class="fas fa-chevron-right">&gt;</i></a></p>
	        	[/spb_text_block] [spb_text_block pb_margin_bottom="no" pb_border_bottom="no" width="1/4" el_position="last"]
	        	
	        	[chart percentage="100" size="170" barcolour="#1bbeb4" trackcolour="#baebe8" content="fas fa-eye-open" align="center"]
	        	<h3 style="text-align: center;">Stunning Sliders</h3>
	        	...
	        	[/spb_text_block] [blank_spacer height="28px" width="1/1" el_position="first last"] [clients_featured title="Our Amazing Clients" category="all" alt_background="alt-two" el_class="no-arrow" width="1/1" el_position="first last"] [blank_spacer height="28px" width="1/1" el_position="first last"] [spb_text_block title="Unlimited Colors" icon="fas fa-tint" pb_margin_bottom="no" pb_border_bottom="no" width="1/4" el_position="first"]
	        	...
	        	<a class="read-more" href="#">Find out more <i class="fas fa-chevron-right">&gt;</i></a>
	        	
	        	[/spb_text_block] [spb_text_block title="Extensive Options" icon="fas fa-wrench" pb_margin_bottom="no" pb_border_bottom="no" width="1/4"]
	        	
	        	Lorem ipsum dolor sit amet, cons tet ur adipisicing et elit, sed mod. incidid un ut out labore et dolore magna minim veniam, quis.
	        	
	        	<a class="read-more" href="#">Find out more <i class="fas fa-chevron-right">&gt;</i></a>
	        	
	        	[/spb_text_block] [spb_text_block title="Shortcode Library" icon="fas fa-cog" pb_margin_bottom="no" pb_border_bottom="no" width="1/4"]
	        	
	        	Lorem ipsum dolor sit amet, cons tet ur adipisicing et elit, sed mod. incidid un ut out labore et dolore magna minim veniam, quis.
	        	
	        	<a class="read-more" href="#">Find out more <i class="fas fa-chevron-right">&gt;</i></a>
	        	
	        	[/spb_text_block] [spb_text_block title="Font Awesome Icons" icon="fas fa-bolt" pb_margin_bottom="no" pb_border_bottom="no" width="1/4" el_position="last"]
	        	
	        	Lorem ipsum dolor sit amet, cons tet ur adipisicing et elit, sed mod. incidid un ut out labore et dolore magna minim veniam, quis.
	        	
	        	<a class="read-more" href="#">Find out more <i class="fas fa-chevron-right">&gt;</i></a>
	        	
	        	[/spb_text_block] [blank_spacer height="30px" width="1/1" el_position="first last"] [spb_text_block title="Page Templates" icon="fas fa-copy" pb_margin_bottom="no" pb_border_bottom="no" width="1/4" el_position="first"]
	        	
	        	Lorem ipsum dolor sit amet, cons tet ur adipisicing et elit, sed mod. incidid un ut out labore et dolore magna minim veniam, quis.
	        	
	        	<a class="read-more" href="#">Find out more <i class="fas fa-chevron-right">&gt;</i></a>
	        	
	        	[/spb_text_block] [spb_text_block title="5-Star Support" icon="fas fa-trophy" pb_margin_bottom="no" pb_border_bottom="no" width="1/4"]
	        	
	        	Lorem ipsum dolor sit amet, cons tet ur adipisicing et elit, sed mod. incidid un ut out labore et dolore magna minim veniam, quis.
	        	
	        	<a class="read-more" href="#">Find out more <i class="fas fa-chevron-right">&gt;</i></a>
	        	
	        	[/spb_text_block] [spb_text_block title="Translation Ready" icon="fas fa-globe" pb_margin_bottom="no" pb_border_bottom="no" width="1/4"]
	        	
	        	Lorem ipsum dolor sit amet, cons tet ur adipisicing et elit, sed mod. incidid un ut out labore et dolore magna minim veniam, quis.
	        	
	        	<a class="read-more" href="#">Find out more <i class="fas fa-chevron-right">&gt;</i></a>
	        	
	        	[/spb_text_block] [spb_text_block title="SEO Optimized" icon="fas fa-search" pb_margin_bottom="no" pb_border_bottom="no" width="1/4" el_position="last"]
