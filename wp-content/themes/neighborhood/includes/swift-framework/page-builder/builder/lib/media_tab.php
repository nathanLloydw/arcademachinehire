<?php
	...
	class SwiftPageBuilderImagesMediaTab extends SwiftPageBuilderMediaTab {
	    ...
	    public function __construct() {
	        parent::__construct();
	        $this->title = __('Image Gallery', 'neighborhood');
	        $this->pageLimit = 10;
	    ...
	    public function getContentList() {
	        ...
	        if ( $page_links )
	            echo '<br/><div class="tablenav"><div id="spb_spinner" style="display: none;"> '.__("Loading, please wait...", 'neighborhood').'</div><div class="tablenav-pages">' . $page_links . '</div></div>';
	    ...
	    public function formTemplate($type = 'file', $errors = null, $id = null)
	    {
	        ...
	        <div class="spb_media_tab row-fluid">
	            ...
	            <h2 class="media-title"><?php _e('Click image from media library or drag it to the "Selected images" area', 'neighborhood'); ?></h2>
	            ...
	            <form enctype="multipart/form-data" method="post" action="<?php echo esc_attr($form_action_url); ?>" class="<?php echo $form_class; ?>" id="<?php echo $this->type; ?>-form">
	                ...
	                <h2 class="media-title"><?php _e('or add images from your computer.', 'neighborhood'); ?></h2>
	            ...
	            <div class="span6 selected_items">
	                <h2><?php _e('Selected images', 'neighborhood') ?></h2>
	                <p><?php _e('Use your mouse to drag images around to place them in the desired order.', 'neighborhood') ?></p>
	                <div class="border">
	                ...
	                <br/>
	                <button class="button-primary" id="vpb_send_selected_files"><?php _e('Update files list', 'neighborhood') ?></button>
	            </div>
	            <script type="text/javascript">
	                jQuery(document).ready(function($){
