...
class RWMB_Select_Field extends RWMB_Choice_Field
{
	...
	public static function get_select_all_html( $field )
	{
		...
		{
			return '<div class="rwmb-select-all-none">' . __( 'Select', 'neighborhood' ) . ': <a data-type="all" href="#">' . __( 'All', 'neighborhood' ) . '</a> | <a data-type="none" href="#">' . __( 'None', 'neighborhood' ) . '</a></div>';
		}
		return '';
	}
}
