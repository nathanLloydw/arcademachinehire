...
//      echo '<img class="redux-opts-screenshot" id="redux-opts-screenshot-' . $this->field['id'] . '" src="' . $this->value . '" />';
        ...
        echo ' <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="redux-opts-upload-scheme button-secondary"' . $upload . ' rel-id="' . $this->field['id'] . '">' . __('Import', 'neighborhood') . '</a>';
        echo ' <span class="import-schema-message" style="display:none;">Import Successful</span> ';
//      echo ' <a href="javascript:void(0);" class="redux-opts-upload-scheme-remove"' . $remove . ' rel-id="' . $this->field['id'] . '">' . __('Remove Upload', 'neighborhood') . '</a>';
