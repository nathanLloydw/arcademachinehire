    ...
    if ( ! function_exists( 'sf_super_search' ) ) {
        function sf_super_search($pos = "") {
            ...
            if ( $ss_enable ) {
                ...
                $ss_final_text = __($options['ss_final_text'], 'neighborhood');
                $ss_button_text = __($options['ss_button_text'], 'neighborhood');
                $field1_text = __($options['field1_text'], 'neighborhood');
                $field1_filter = __($options['field1_filter'], 'neighborhood');
                $field1_default_text = __($options['field1_default_text'], 'neighborhood');
                $field2_text = __($options['field2_text'], 'neighborhood');
                $field2_filter = __($options['field2_filter'], 'neighborhood');
                $field2_default_text = __($options['field2_default_text'], 'neighborhood');
                $field3_text = __($options['field3_text'], 'neighborhood');
                $field3_filter = __($options['field3_filter'], 'neighborhood');
                $field3_default_text = __($options['field3_default_text'], 'neighborhood');
                $field4_text = __($options['field4_text'], 'neighborhood');
                $field4_filter = __($options['field4_filter'], 'neighborhood');
                $field4_default_text = __($options['field4_default_text'], 'neighborhood');
                $field5_text = __($options['field5_text'], 'neighborhood');
                $field5_filter = __($options['field5_filter'], 'neighborhood');
                $field5_default_text = __($options['field5_default_text'], 'neighborhood');
                $field6_text = __($options['field6_text'], 'neighborhood');
                $field6_filter = __($options['field6_filter'], 'neighborhood');
                $field6_default_text = __($options['field6_default_text'], 'neighborhood');         
    ...
    if ( ! function_exists( 'sf_super_search_dropdown' ) ) {
        function sf_super_search_dropdown( $index, $option, $text ) {
            ...
            if ( $option == "price" ) {
                ...
                $sf_ss_dropdown .= '<ul>';
                $sf_ss_dropdown .= '<li>';
                $sf_ss_dropdown .= '<a class="ss-option" href="#" data-attr_value="">' . __( "Any", 'neighborhood' ) . '</a>';
                $sf_ss_dropdown .= '<i class="fas fa-check"></i>';
                $sf_ss_dropdown .= '</li>';
