			...
			<section class="article-body-wrap">
				...
				<?php if (!$hide_details) { ?>
					...
					<div class="portfolio-details-wrap">
						<?php if ($item_client) { ?>
						<span class="client"><?php _e("Client: ", 'neighborhood'); ?><span><?php echo $item_client; ?></span></span>
						<?php } ?>
						<span class="date"><?php _e("Date: ", 'neighborhood'); ?><span><?php echo $item_date; ?></span></span>
						<span class="tags-wrap"><?php _e("Category: ", 'neighborhood'); ?><span class="tags"><?php echo $item_categories; ?></span></span>
						<?php if ($item_link) { ?>
						<a class="item-link" href="<?php echo $item_link; ?>" target="_blank"><?php _e("View Project", 'neighborhood'); ?><i class="fas fa-angle-right"></i></a>
						<?php } ?>
					</div>
				...
				<div class="pagination-wrap portfolio-pagination container clearfix">
					<div class="nav-previous"><?php next_post_link(__('<i class="fas fa-angle-left"></i> <span class="nav-text">%link</span>', 'neighborhood'), '%title'); ?></div>
					<div class="nav-next"><?php previous_post_link(__('<span class="nav-text">%link</span><i class="fas fa-angle-right"></i>', 'neighborhood'), '%title'); ?></div>
				</div>	
